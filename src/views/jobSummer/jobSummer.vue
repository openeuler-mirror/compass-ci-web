    ...
    <div class="content">
      ...
      <el-form :model="listQuery">
          ...
          <el-form-item label="Group By" class="group-by">
            <el-input v-model="listQuery.GROUP_BY" placeholder="eg:os_version"  @keydown.enter.native="getData"></el-input>
          </el-form-item>
      ...
      <el-table :data="tableData" stripe>
        <el-table-column v-for="(item,index) in tableHead" :label="item" :prop="item" width="" :key="index">
            <template slot-scope="scope">
                <div class="go" v-if="item==='nr_fail'" @click="handleClick(scope.row[listQuery.GROUP_BY])">{{scope.row[item]}}</div>
