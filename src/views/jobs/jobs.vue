<template>
  <div id="jobs">
    ...
    <div class="content">
      ...
      <el-row :gutter="10">
        <el-col :xs="40" :sm="10" :md="10" :lg="8" :xl="1" class="jobs-tips">
          <span class="page-tips">reports per page</span>
          <el-select v-model="listQuery.page_size" placeholder="请选择" size="medium" @change="getJobs">
            <el-option v-for="item in pageSizeOptions" :key="item" :label="item" :value="item"></el-option>
          </el-select>
        </el-col>
        <el-col :xs="20" :sm="11" :md="10" :lg="5" :xl="1" class="jobs-tips">
          <el-input
      ...
      <el-table :data="tableData" stripe class="jobs-data">
          <el-table-column :label="item" :key="index" v-for="(item,index) in tableHead" :show-overflow-tooltip="true">
